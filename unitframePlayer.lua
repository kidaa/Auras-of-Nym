...
playerFrame.valueTP.x = playerFrame.tpbar.x + 4
playerFrame.valueTP.y = playerFrame.tpbar.y + playerFrame.tpbar.maxHeight + 7
...
playerFrame.percentHP.x = playerFrame.hpbar.x + 23 -- + 18
